...
export default function Converstation() {
  ...
  const { userData, getConversation, getUserDoc, createMessage } = useFirestore();
  ...
  return (
    ...
    {user && (
      <div className="w-full h-full py-4 mt-14">
        ...
        <form
          className="fixed bottom-0 flex w-full p-4 justify-around bg-dark"
        >
          <input
            className="flex-1 px-2 dark:text-white bg-dark"
            type="text"
